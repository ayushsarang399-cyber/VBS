...
public class TransactionController {
    ...
    public List<Transaction> getPassbook(@PathVariable int id) //list array ka bada bhai , dynamic array(bharte jao)
    {
        return transactionRepo.findAllByUserId(id); //findAllBy sabkuch chapega
    }
}
